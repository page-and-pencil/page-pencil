...
- Contractions always.
- **NO em dashes (—) or en dashes (–). EVER. ABSOLUTE HARD RULE, no exceptions.** AI overuses them and they are a top tell. Use a comma, period, colon, semicolon, or parentheses instead. If a sentence wants an em dash, rewrite it or split it.
...
### 3·0. Em dashes and en dashes (HARD)

Never use the em dash (—) or en dash (–) in English writing. ABSOLUTE. Not for asides, not for emphasis, not for ranges, not anywhere. Replace with a comma, period, colon, semicolon, or parentheses, or rewrite the sentence. A single em dash fails the output.
...
**Frequency guidance:**
- **HARD RULE:** Never violate. Banned words, structures, phrases, and em/en dashes. Absolute.
